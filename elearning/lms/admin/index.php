...
$batch_browser=$batch_con->browser();
									...
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												...
												<h1 class="mt-1 mb-3"><?php echo sizeof($batchs); ?></h1>
												<div class="mb-0">
								...
								<div class="card-body d-flex">
									<div class="align-self-center w-100">
										...
										<table class="table mb-0">
											...
											<?php
											$count=1;
											foreach($batch_browser as $batches)
											{
												echo "<tr>";
												echo "<td>".$count++. "</td>";
												echo "<td>". $batches['cname']. "</td>";
												echo "<td>". $batches['total']. "</td>";
												echo "</tr>";
											}
											?>										
											</tbody>
